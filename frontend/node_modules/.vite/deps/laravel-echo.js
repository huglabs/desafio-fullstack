...
var o = class extends r {
	...
	*/
	privateChannel(e) {
		return this.channels["private-" + e] || (this.channels["private-" + e] = new d(this.pusher, "private-" + e, this.options)), this.channels["private-" + e];
	}
	/**
	...
	*/
	presenceChannel(e) {
		return this.channels["presence-" + e] || (this.channels["presence-" + e] = new w(this.pusher, "presence-" + e, this.options)), this.channels["presence-" + e];
	}
	/**
...
var m = class extends r {
	...
	*/
	channel(e) {
		return this.channels[e] || (this.channels[e] = new f(this.socket, e, this.options)), this.channels[e];
	}
	/**
	* Get a private channel instance by name.
	*/
...
var S = class {
	...
	*/
	connect() {
		...
		else if (this.options.broadcaster === "socket.io") this.connector = new m(this.options);
		else if (this.options.broadcaster === "null") this.connector = new l(this.options);
		else if (typeof this.options.broadcaster == "function" && k(this.options.broadcaster)) this.connector = new this.options.broadcaster(this.options);
...
//#endregion
export { a as Channel, r as Connector, p as EventFormatter, S as default };
